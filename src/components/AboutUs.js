  ...
  return (
    <div className="about-us-container">
      ...
      <div className="text-container">
        <h2>About Us</h2>
        <p>
          Welcome to the <span >ISAMM Microsoft Club </span>, your gateway to a world of technology, innovation, and career growth.
          ...
          Embrace the future of technology with <span >ISAMM Microsoft Club</span> where we are driven by passion!
           </p>
      </div>
    </div>
  );
